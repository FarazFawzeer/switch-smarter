...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .sc-chain-item { display: block; font-size: 12px; color: #56606f; line-height: 1.6; }
        .sc-chain-item iconify-icon { color: #8792a2; margin-right: 4px; font-size: 13px; }
    ...
    <div class="sc-intro">
        ...
        <div>
            ...
            The visit then repeats every month automatically until the contract ends.
        </div>
    </div>
